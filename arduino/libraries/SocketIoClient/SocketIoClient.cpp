...
void SocketIoClient::enableHeartbeat(uint32_t pingInterval, uint32_t pingTimeout, uint8_t pingCount) {
	_webSocket.enableHeartbeat(pingInterval, pingTimeout, pingCount);
}
